...
int32_t Queue_Init (QueueBufferObject_TypeDef * const pInit, QueueBufferInit_Typedef * pInitData);
int32_t Queue_DeInit (QueueBufferObject_TypeDef * const pInit);
int32_t Queue_Write (QueueBufferObject_TypeDef * const pInit, void * const pData, size_t const Size);
int32_t Queue_Read (QueueBufferObject_TypeDef * const pInit, void * const pData, size_t const Size);
